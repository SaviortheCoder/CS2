...
public class dobra {
    ...
    public static int solution_count() {
        ...
        if (dobra.checkL() == true) {
            return recur_Sol(0, true);
        } else {
            return recur_Sol(0, false);
        }
    }
    ...
    public static int recur_Sol(int index, boolean has_L) {
                    ...
                    if (dobra.checkConsonants() == true && dobra.checkVowels() == true) {
                        ...
                        if (input.length() - 1 == index) { //
                            ...
                            if (dobra.checkL() == true) {
                                ...
                                //changing chek L logic to using flag variables
                                ret += 1 + recur_Sol(index + 1, true);
